...
import { IconButton, Button, TextField, Typography, Grid } from '@material-ui/core';
        ...
        { Poaps && Poaps.length > 0 && (
          <>
            ...
            <div className='manage-cards'>
              { Poaps.map(Poap => {
                  return (
                    <div key={Poap.id} className='manage-card card-padding'>
                      <div>
                          <Grid
                          ...
                          >
                            <Grid item>
                              <Typography component="p">
                                <Link to={`/poap/${Poap.id}`} className='poapman-link'>{Poap.name}</Link>
                              </Typography>
                              {Poap.id}
                            </Grid>
                            <Grid item>
